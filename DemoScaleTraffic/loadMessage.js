...
export const options = {
  stages: [
    ...
    { duration: '30s', target: 2000 }, // giữ ổn định ở 1000 user trong 30s
    { duration: '10s', target: 0 },    // giảm dần từ 1000 → 0 user trong 10s
  ],
};
export default function () {
  const fullUrl = `http://localhost/api/chat/message/get-messages?sender=03351288670&receiver=0333657670&is_group=false&limit=5`;
